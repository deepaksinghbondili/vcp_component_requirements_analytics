		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#vcpappvcpcomponentrequirements-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vcpappvcpcomponentrequirements-display": {
								"semanticObject": "vcpappvcpcomponentrequirements",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vcpapp.vcpcomponentrequirements",
									"url": sap.ui.require.toUrl("vcpapp/vcpcomponentrequirements")
								}
							}
						}
					}
